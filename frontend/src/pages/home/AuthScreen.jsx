		...
		<div className='hero-bg relative'>
			...
			<div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
				...
				<form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleFormSubmit}>
					...
					/>
					<button className='bg-red-600 text-xl lg:text-2xl px-8 py-1 md:py-2 rounded flex justify-center items-center'>
						Get Started
			...
			<div className='py-10 bg-black text-white'>
				<div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
					...
					<div className='flex-1 relative'>
						...
						<video
							className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[54%] z-10'
							playsInline
							autoPlay={true}
							muted
							loop
			...
			<div className='py-10 bg-black text-white'>
				<div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
					...
					<div className='flex-1 relative overflow-hidden'>
						<img src='/device-pile.png' alt='Device pile image' className='mt-4 z-20 relative' />
						<video
							className='absolute top-2 left-1/2 -translate-x-1/2  h-[47%] z-10
               max-w-[63%] 
              '
							playsInline
							autoPlay={true}
