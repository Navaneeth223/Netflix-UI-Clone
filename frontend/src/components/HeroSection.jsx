...
const HeroSection = ({ trendingContent }) => {
	const [imgLoading, setImgLoading] = useState(true);

	return (
		<div className='relative h-screen text-white '>
			{/* COOL OPTIMIZATION FOR IMAGES */}
			{imgLoading && (
			...
			<div className='absolute top-0 left-0 w-full h-full bg-black/40 -z-50' aria-hidden='true' />

			<div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
				<div
					className='bg-gradient-to-b from-black/80 via-transparent to-transparent 
